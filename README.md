...
- **SEO optimized** with structured data and performance best practices
...
sales/                      — One-pager, audit template, outreach emails
README.md                   — This file
```

## Performance Notes

- **Lighthouse Score:** 90+ (fast, accessible, SEO-friendly)
- **Core Web Vitals:** Passing (optimized for Google rankings)
...
**Built with clean HTML, CSS variables, and vanilla JavaScript. No frameworks, no bloat.**
